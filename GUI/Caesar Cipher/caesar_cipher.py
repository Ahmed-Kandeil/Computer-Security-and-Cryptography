...
This file contains a class called CaesarCipher which can be
used to encrypt and decrypt messages using the caesar cipher.
"""
...
class CaesarCipher:
    """
    A class to encrypt and decrypt messages using the caesar cipher.
    ...
    def __init__(self, key: int = 13) -> None:
        """
        Initializes a new CaesarCipher object.
    ...
    def generate_maps(self) -> None:
        """
        Generates the encryption and decryption maps.
        """

        alphabet = string.ascii_letters
        shifted_alphabet = alphabet[self.__key :] + alphabet[: self.__key]
    ...
    def encrypt(self, plain_text: str) -> str:
        ...
        return "".join([self.encrypt_map.get(char, char) for char in plain_text])
    ...
    def decrypt(self, cipher_text: str) -> str:
        ...
        return "".join([self.decrypt_map.get(char, char) for char in cipher_text])
...
def main() -> None:
    ...
    encrypter = CaesarCipher(key=key)
